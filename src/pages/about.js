        ...
        <div className='h-screen flex justify-center items-center bg-yellow-200'>
                <div className='grid lg:grid-cols-2 py-20 max-w-7xl mx-auto'>
                    <div className="py-10 px-10">
                        ...
                        <p className="py-10 text-base"> Mi persona, Estudié Ingenieria de Sistemas con poca experiencia en el mundo del desarrollo me anime a tomar un BootCamp en Tzuzul y con esta pequeña App trato de demostrar todo lo apredido.
